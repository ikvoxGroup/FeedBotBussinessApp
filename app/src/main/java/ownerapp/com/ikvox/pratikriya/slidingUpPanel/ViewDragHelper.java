...
package ownerapp.com.ikvox.pratikriya.slidingUpPanel;
...
public class ViewDragHelper {
     ...
     *
     * @param v View to add_query for horizontal scrollability
     ...
     * will return false.
     *
     * @param x X position to add_query in the parent's coordinate system
     * @param y Y position to add_query in the parent's coordinate system
     ...
     *
     * @param view Child view of the parent to hit add_query
     * @param x X position to add_query in the parent's coordinate system
     * @param y Y position to add_query in the parent's coordinate system
